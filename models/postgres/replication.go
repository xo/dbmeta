...
func registerPublications() {
	dbmeta.Publications.Register(dbmeta.PostgreSQL, &dbmeta.Binding[dbmeta.Publication]{
		Stmt: dbmeta.Stmt{
			...
			{{Min: v10, SQL: `, COALESCE(pg_catalog.obj_description(p.oid, 'pg_publication'), '') AS "comment"`}},
	...
	dbmeta.PublicationTables.Register(dbmeta.PostgreSQL, &dbmeta.Binding[dbmeta.PublicationTable]{
		Stmt: dbmeta.Stmt{
			...
			},
			{
				...
				{Min: v15, SQL: `, COALESCE(pg_catalog.pg_get_expr(pr.prqual, c.oid), '') AS "where"`},
			},
			{{Min: v10, SQL: `FROM pg_catalog.pg_publication p`}},
...
func registerSubscriptions() {
	dbmeta.Subscriptions.Register(dbmeta.PostgreSQL, &dbmeta.Binding[dbmeta.Subscription]{
		Stmt: dbmeta.Stmt{
			...
			{{Min: v10, SQL: `, COALESCE(s.subsynccommit, '') AS "synchronous"`}},
			{{Min: v10, SQL: `, COALESCE(s.subslotname, '') AS "slot"`}},
			{{Min: v10, SQL: `, COALESCE(pg_catalog.shobj_description(s.oid, 'pg_subscription'), '') AS "comment"`}},
...
func registerTextSearch() {
	dbmeta.TextSearchParsers.Register(dbmeta.PostgreSQL, &dbmeta.Binding[dbmeta.TextSearchParser]{
		Stmt: dbmeta.Stmt{
			...
			{{SQL: `, COALESCE(pg_catalog.obj_description(p.oid, 'pg_ts_parser'), '') AS "comment"`}},
	...
	dbmeta.TextSearchDictionaries.Register(dbmeta.PostgreSQL, &dbmeta.Binding[dbmeta.TextSearchDictionary]{
		Stmt: dbmeta.Stmt{
			...
			{{SQL: `, COALESCE(d.dictinitoption, '') AS "options"`}},
			{{SQL: `, COALESCE(pg_catalog.obj_description(d.oid, 'pg_ts_dict'), '') AS "comment"`}},
	...
	dbmeta.TextSearchTemplates.Register(dbmeta.PostgreSQL, &dbmeta.Binding[dbmeta.TextSearchTemplate]{
		Stmt: dbmeta.Stmt{
			...
			{{SQL: `, COALESCE(t.tmplinit::pg_catalog.regproc::text, '') AS "init"`}},
			{{SQL: `, t.tmpllexize::pg_catalog.regproc::text AS "lexize"`}},
			{{SQL: `, COALESCE(pg_catalog.obj_description(t.oid, 'pg_ts_template'), '') AS "comment"`}},
	...
	dbmeta.TextSearchConfigs.Register(dbmeta.PostgreSQL, &dbmeta.Binding[dbmeta.TextSearchConfig]{
		Stmt: dbmeta.Stmt{
			...
			{{SQL: `, COALESCE(pg_catalog.obj_description(c.oid, 'pg_ts_config'), '') AS "comment"`}},
...
func registerExtensions() {
	dbmeta.Extensions.Register(dbmeta.PostgreSQL, &dbmeta.Binding[dbmeta.Extension]{
		Stmt: dbmeta.Stmt{
			...
			{{SQL: `, n.nspname AS "schema"`}},
			{{SQL: `, COALESCE(pg_catalog.obj_description(e.oid, 'pg_extension'), '') AS "comment"`}},
	...
	dbmeta.ExtendedStats.Register(dbmeta.PostgreSQL, &dbmeta.Binding[dbmeta.ExtendedStat]{
		Stmt: dbmeta.Stmt{
			...
			{{Min: v10, SQL: `, COALESCE(pg_catalog.obj_description(s.oid, 'pg_statistic_ext'), '') AS "comment"`}},
