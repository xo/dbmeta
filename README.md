...
| --- | --- |
| [`PLAN.md`](docs/PLAN.md) | Every decision, 58 of them, with the reasoning and what was rejected. A table at the top lists them with their status, because six amend or replace an earlier one. |
